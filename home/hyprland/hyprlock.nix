{
  programs.hyprlock = {
    ...
    settings =
      ...
      in
      {
        # Refer https://wiki.hypr.land/Hypr-Ecosystem/hyprlock/
        "$font" = "Monospace";
        ...
        input-field = {
          ...
          # Uncomment to use an input indicator that does not show the password
          # length (similar to swaylock's input indicator)
          # hide_input = true;
          position = "0, -20";
          halign = "center";
          valign = "center";
        ...
        label = [
          {
            # TIME
            monitor = "";
            text = "$TIME"; # ref. https://wiki.hypr.land/Hypr-Ecosystem/hyprlock/#variable-substitution
            font_size = 90;
            font_family = "$font";
